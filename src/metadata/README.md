 ...
 * [more.yml](more.yml)
     * Determines how your purl.obolibrary.org/obo/more/ redirects will be handled
     ...
     * Paste in the contents of [more.yml](more.yml)
 ...
 * [more.md](more.md)
     ...
     * Paste in the contents of [more.md](more.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
